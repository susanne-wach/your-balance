...
| Winterfest / Das Winterhaus (Nov. 2026 bis Jan. 2027) | **Keine eigenen Seiten** (Susanne 23.09.2026): Menüeinträge, das Winter-Band (Marker `WINTER-BAND` in index/angebote/kurse) und die drei Kurse-Karten verlinken direkt auf die ThriveCart-Kassen `your-balance.thrivecart.com/winterfest/` (152/153) und `/winterhaus/` (151). Setzt `07_Claude/projects/begleitung-3-monate/verkaufsseiten/homepage_verlinken.py` (`--entfernen` nach dem Winter) und `kurse_seite_tauschen.py`. Dazu `winterfest-live-abende.ics` / `winterhaus-live-abende.ics` (Kalenderdateien der Live-Abende, Bau `mails/bau_kalender.py`), verlinkt auf den drei Danke-Seiten und in den Willkommensmails, und `assets/images/winterhaus/haus-alpental-mail.png` sowie `trailer-poster-mail.jpg` für die Newsletter. Kostenloser Live-Abend Di 20.10.2026: `winter-abend.html` (Anmeldung, AC-Formular 52, Danke-Zustand mit `winter-abend.ics`), `winter-abend-aufzeichnung.html` (nach dem Abend mit `--video-url` neu bauen), Bau `07_Claude/projects/begleitung-3-monate/live-abend/bau_abend_seiten.py`. Alles live seit 24.09.2026 |
